...
<template>
	<div>
		<div class="main-profile flex gap-10 justify-center items-center">
			<div class='col'>
				<img class="w-36 h-36 rounded-full mb-5" src="/src/assets/images/image.png"></img>
			</div>
			<div>
			...
			<div class = "flex flex-col">
				<input class='text-input mb-[20px]' type="text">
				<input class='text-input mb-[20px]' type="text">
			</div>
		</div>
		...
		<div class = "center-settings flex gap-10 justify-center items-center">
			...
			<div>
				...
				<div>
					...
					<textarea class='detailed-input mb-[20px]' type="text"></textarea>
				</div>
			</div>
